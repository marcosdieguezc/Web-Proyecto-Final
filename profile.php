	...
	<div class="navbar navbar-default navbar-fixed-top"  id="topnav">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				<li id='shoppingcart'><a id="carticon" href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span>Carrito <span class="badge">2</span>	</a>
					<div class="dropdown-menu" style="width: 400px;">
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="row">
									<div class="col-md-3"><strong>S. No.</strong></div>
									<div class="col-md-3"><strong>Imagen del producto</strong></div>
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span>Bienvenido, <?php echo $_SESSION['uname']; ?></a>
				...
				<div class="panel panel-info">
					<div class="panel-heading text-center">Productos
							<div class='pull-right'>
								Ordenar por: &nbsp;&nbsp;&nbsp;<a href="#" id='price_sort'>Precio</a> | <a href="#" id='pop_sort'>Popularidad</a>
							</div>
					</div>

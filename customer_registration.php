		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading">Darse de alta</div>
				...
				<form method="post" action="">
					...
					<div class="row">
						<div class="col-md-12">
							<label for="address1">Dirrección</label>
					...
					<div class="row">
						<div class="col-md-12">
							<label for="address2">Dirrección 2</label>
					...
					<br><br>
					<div class="col-md-12">
						<input type="button" class="btn btn-primary" value="Darse de alta" name="signup" id="signup_btn">
					</div>

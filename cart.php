			...
			<div class="row">
				...
				<div class="panel panel-primary text-center">
					...
					<div class="row">
						...
						<div class="col-md-2"><b>Imagen del producto</b></div>
						<div class="col-md-2"><b>Nombre del producto</b></div>
				...
				<button class='btn btn-success btn-lg pull-right' id='checkout_btn' data-toggle="modal" data-target="#myModal">Pagar</button>
			</div>
